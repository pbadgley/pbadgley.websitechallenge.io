...
function za(a){if(!Aa.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ba,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Ea,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Fa,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Ga,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Ha,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Ia,"&#0;"));return a}
var Ba=/&/g,Ea=/</g,Fa=/>/g,Ga=/"/g,Ha=/'/g,Ia=/\x00/g,Aa=/[\x00&<>"']/;function Ja(a,b){return a<b?-1:a>b?1:0}
...
;var fb=D("Opera"),E=D("Trident")||D("MSIE"),gb=D("Edge"),hb=D("Gecko")&&!(-1!=Sa.toLowerCase().indexOf("webkit")&&!D("Edge"))&&!(D("Trident")||D("MSIE"))&&!D("Edge"),ib=-1!=Sa.toLowerCase().indexOf("webkit")&&!D("Edge");function kb(){var a=p.document;return a?a.documentMode:void 0}
...
nb&&(mb=nb?nb[1]:"");if(E){var ob=kb();if(null!=ob&&ob>parseFloat(mb)){lb=String(ob);break a}}lb=mb}var pb=lb,eb={};
...
var qb;var rb=p.document;qb=rb&&E?kb()||("CSS1Compat"==rb.compatMode?parseInt(pb,10):5):void 0;var sb=!E||9<=Number(qb);!hb&&!E||E&&9<=Number(qb)||hb&&F("1.9.1");E&&F("9");function tb(){this.b="";this.g=ub}
...
var M,N;function Hd(){Fd=p;M=Fd.googleToken=Fd.googleToken||{};var a=z();M[1]&&M[3]>a&&0<M[2]||(M[1]="",M[2]=-1,M[3]=-1,M[4]="",M[6]="");N=Fd.googleIMState=Fd.googleIMState||{};Ed(N[1])||(N[1]=".google.com");w(N[5])||(N[5]=[]);"boolean"==typeof N[6]||(N[6]=!1);w(N[7])||(N[7]=[]);"number"==typeof N[8]||(N[8]=0)}
...
function Kd(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g=parseInt(b.freshLifetimeSecs||"",10)||3600,h=parseInt(b.validLifetimeSecs||"",10)||86400,k=b["1p_jar"]||"";b=b.pucrd||"";Hd();1==e?O.La():O.Ka();if(!f&&O.shouldRetry())Ed(".google.com")&&(N[1]=".google.com"),O.fa();else{var m=Fd.googleToken=Fd.googleToken||{},u=0==e&&f&&r(f)&&0<g&&0<h&&r(k),P=!(M[3]>=z())&&0!=e;if(u||P)u=z(),g=u+1E3*g,h=u+1E3*h,1E-5>Math.random()&&
...
;function If(a,b,c,d){var e=Jf,f={};f.eventTimeMs=Math.round(c||Md());f[a]=b;f.context={lastActivityMs:String(c?-1:hf())};Df({endpoint:"log_event",payload:f,V:d},e)}
;function Kf(a,b,c){c.context&&c.context.capabilities&&(c=c.context.capabilities,c.snapshot||c.golden)&&(a="vix");return"/youtubei/"+a+"/"+b}
...
timeout:d.timeout,withCredentials:!0},f=Yb();f&&(e.headers.Authorization=f,e.headers["X-Goog-AuthUser"]=R("SESSION_INDEX",0));var g="",h=a.b.Da;h&&(g=h);f&&!g&&(e.headers["x-origin"]=window.location.origin);a=""+g+Kf(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey;T("use_fetch_for_op_xhr")?Ae(a,e):Je(a,e)}
;function Lf(a,b,c){Mf({attachChild:{csn:a,parentVisualElement:kf(b),visualElements:[kf(c)]}})}
function Mf(a){var b=Jf;a.eventTimeMs=Math.round(Md());a.lactMs=hf();Df({endpoint:"log_interaction",payload:a},b)}
...
;var Zf={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1,kitkat:4.4,lollipop:5.1,marshmallow:6,nougat:7.1};var $f=Sa;$f=$f.toLowerCase();if(-1!=$f.indexOf("android")&&!$f.match(/android\D*(\d\.\d)[^;|\)]*[;\)]/)){var ag=[],bg=0,cg;for(cg in Zf)ag[bg++]=cg;$f.match("("+ag.join("|")+")")};var dg=v("ytLoggingLatencyUsageStats_")||{};t("ytLoggingLatencyUsageStats_",dg,void 0);var eg=0;function fg(a){dg[a]=dg[a]||{count:0};var b=dg[a];b.count++;b.time=Md();eg||(eg=Te(gg,0));return 10<b.count?(11==b.count&&Qe(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function gg(){var a=Md(),b;for(b in dg)6E4<a-dg[b].time&&delete dg[b];eg=0}
;function hg(a,b){this.version=a;this.args=b}
;function ig(a){this.topic=a}
ig.prototype.toString=function(){return this.topic};var jg=v("ytPubsub2Pubsub2Instance")||new K;K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.D;K.prototype.publish=K.prototype.G;K.prototype.clear=K.prototype.clear;t("ytPubsub2Pubsub2Instance",jg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
;var W=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function lg(){var a=R("TIMING_TICK_EXPIRATION");a||(a={},Q("TIMING_TICK_EXPIRATION",a));return a}
function mg(){var a=lg(),b;for(b in a)Ue(a[b]);Q("TIMING_TICK_EXPIRATION",{})}
;function ng(a,b){hg.call(this,1,arguments)}
n(ng,hg);function og(a,b){hg.call(this,1,arguments)}
n(og,hg);var pg=new ig("aft-recorded"),tg=new ig("timing-sent");var ug=z().toString();var vg={vc:!0},wg={ad_allowed:"adTypesAllowed",ad_at:"adType",ad_cpn:"adClientPlaybackNonce",ad_docid:"adVideoId",yt_ad_an:"adNetworks",p:"httpProtocol",t:"transportProtocol",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",docid:"videoId",is_nav:"isNavigation",yt_lt:"loadType",yt_ad:"isMonetized",nr:"webInfo.navigationReason",ncnp:"webInfo.nonPreloadedNodeCount",paused:"playerInfo.isPausedOnLoad",fmt:"playerInfo.itag",yt_pl:"watchInfo.isPlaylist",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",
st:"serverTimeMs",vph:"viewportHeight",vpw:"viewportWidth",yt_vis:"isVisible"},xg="ap c cver ei srt yt_fss yt_li ba plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt pc prerender psc rc start yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),yg="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),zg=!1;
function Ag(a){if("_"!=a[0]){var b=a;W.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),W.mark(b))}b=Bg();var c=Md();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=lg();if(c=b[a])Ue(c),b[a]=0;Cg()["tick_"+a]=void 0;Md();T("csi_on_gel")?(b=Dg(),"_start"==a?fg("baseline_"+b)||If("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):fg("tick_"+a+"_"+b)||If("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&
(b=Od("TIMING_ACTION"),a=Bg(),v("ytglobal.timingready_")&&b&&a._start&&(b=Eg()))){T("tighter_critical_section")&&!zg&&(kg(pg,new ng(Math.round(b-a._start),void 0)),zg=!0);b=!0;c=R("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Fg()}}
function Gg(){var a=Hg().info.yt_lt="hot_bg";Cg().info_yt_lt=a;if(T("csi_on_gel"))if("yt_lt"in wg){var b={},c=wg.yt_lt;0<=La(yg,c)&&(a=!!a);c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];b[c[c.length-1]]=a;a=Dg();c=Object.keys(b).join("");fg("info_"+c+"_"+a)||(b.clientActionNonce=a,If("latencyActionInfo",b,void 0,void 0))}else 0<=La(xg,"yt_lt")||S(Error("Unknown label yt_lt logged with GEL CSI."))}
function Eg(){var a=Bg();if(a.aft)return a.aft;for(var b=R("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Fg(){mg();if(!T("csi_on_gel")){var a=Bg(),b=Hg().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&w(a[d])){var e=d.slice(1);if(e in vg){var f=Na(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=v("ytglobal.timingReportbuilder_")){if(f=f(a,b,void 0))Ig(f,e),Jg(),Kg(),Lg(!1,void 0),R("TIMING_ACTION")&&Q("PREVIOUS_ACTION",R("TIMING_ACTION")),Q("TIMING_ACTION","")}else{var g=R("CSI_SERVICE_NAME","youtube");f={v:2,s:g,action:R("TIMING_ACTION",void 0)};var h=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var k=window.location.protocol+v("ytplayer.config.assets.js");(k=W.getEntriesByName?W.getEntriesByName(k)[0]:null)?b.h5jse=Math.round(b.h5jse-k.responseEnd):
delete b.h5jse}a.aft=Eg();Mg()&&"youtube"==g&&(Gg(),g=a.vc,k=a.pbs,delete a.aft,b.aft=Math.round(k-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=Md();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=v("ytdebug.logTiming"))&&a(f,b);Ig(f,e,void 0);kg(tg,new og(b.aft+(h||0),void 0))}}}
var Kg=x(W.clearResourceTimings||W.webkitClearResourceTimings||W.mozClearResourceTimings||W.msClearResourceTimings||W.oClearResourceTimings||pa,W);
function Ig(a,b,c){if(T("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],t("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Me(a,void 0,void 0,void 0,f)}catch(g){Me(a,void 0,void 0,void 0,f)}}else Me(a);Lg(!0,c)}
function Dg(){var a=Hg().nonce;if(!a){a:{if(window.crypto&&window.crypto.getRandomValues)try{var b=Array(16),c=new Uint8Array(16);window.crypto.getRandomValues(c);for(a=0;a<b.length;a++)b[a]=c[a];var d=b;break a}catch(e){}d=Array(16);for(b=0;16>b;b++){c=z();for(a=0;a<c%23;a++)d[b]=Math.random();d[b]=Math.floor(256*Math.random())}if(ug)for(b=1,c=0;c<ug.length;c++)d[b%16]=d[b%16]^d[(b-1)%16]/4^ug.charCodeAt(c),b++}b=[];for(c=0;c<d.length;c++)b.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(d[c]&
63));a=b.join("");Hg().nonce=a}return a}
function Bg(){return Hg().tick}
function Cg(){var a=Hg();"gel"in a||(a.gel={});return a.gel}
function Hg(){return v("ytcsi.data_")||Jg()}
...
;function Ng(a,b){I.call(this);this.m=this.R=a;this.I=b;this.u=!1;this.f={};this.O=this.H=null;this.A=new K;mc(this,y(nc,this.A));this.i={};this.M=this.P=this.h=this.Z=this.b=null;this.L=!1;this.j=this.F=null;this.S={};this.qa=["onReady"];this.Y=null;this.ga=NaN;this.N={};Og(this);this.U("WATCH_LATER_VIDEO_ADDED",x(this.Fa,this));this.U("WATCH_LATER_VIDEO_REMOVED",x(this.Ga,this));this.U("onAdAnnounce",x(this.ta,this));this.ra=new Tf(this);mc(this,y(nc,this.ra))}
n(Ng,I);l=Ng.prototype;
l.da=function(a){if(!this.g){this.Z=a;this.b=Sf(a);this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.I,this.b.attrs.id=this.I);this.m.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.I;this.P||(this.P=Pg(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.m.style.width=Qb(Number(a)||a);if(a=this.b.attrs.height)this.m.style.height=Qb(Number(a)||a);this.g||
Qg(this);this.u&&Rg(this)}};
...
function Sg(a){var b=!0,c=Tg(a);c&&a.b&&(a=a.b,b=Td(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function Qg(a){if(!a.L){var b=Sg(a);if(b&&"html5"==(Tg(a)?"html5":null))a.M="html5",a.u||a.X();else if(Ug(a),a.M="html5",b&&a.j)a.R.appendChild(a.j),a.X();else{a.b.loaded=!0;var c=!1;a.F=x(function(){c=!0;var a=Sf(this.b);v("yt.player.Application.create")(this.R,a);this.X()},a);
a.L=!0;b?a.F():(he(a.b.assets.js,a.F),Vf(a.b.assets.css),Vg(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function Tg(a){var b=Hb(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
l.X=function(){if(!this.g){var a=Tg(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b){if(this.L=!1,!a.isNotServable||!a.isNotServable(this.b.args.video_id)){Og(this);this.u=!0;a=Tg(this);a.addEventListener&&(this.H=Wg(this,a,"addEventListener"));a.removeEventListener&&(this.O=Wg(this,a,"removeEventListener"));b=a.getApiInterface();b=b.concat(a.getInternalApiInterface());for(var c=0;c<b.length;c++){var d=b[c];this.f[d]||(this.f[d]=Wg(this,a,d))}for(var e in this.i)this.H(e,
this.i[e]);Rg(this);this.P&&this.P(this.f);this.A.G("onReady",this.f)}}else this.ga=U(x(this.X,this),50)}};
function Wg(a,b,c){var d=b[c];return function(){try{return a.Y=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.Y=e,S(e,"WARNING"))}}}
function Og(a){a.u=!1;if(a.O)for(var b in a.i)a.O(b,a.i[b]);for(var c in a.N)Vd(parseInt(c,10));a.N={};a.H=null;a.O=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=x(a.U,a);a.f.removeEventListener=x(a.Ma,a);a.f.destroy=x(a.dispose,a);a.f.getLastError=x(a.xa,a);a.f.getPlayerType=x(a.ya,a);a.f.getCurrentVideoConfig=x(a.wa,a);a.f.loadNewVideoConfig=x(a.da,a);a.f.isReady=x(a.Ea,a)}
l.Ea=function(){return this.u};
l.U=function(a,b){if(!this.g){var c=Pg(this,b);if(c){if(!(0<=La(this.qa,a)||this.i[a])){var d=Xg(this,a);this.H&&this.H(a,d)}this.A.subscribe(a,c);"onReady"==a&&this.u&&U(y(c,this.f),0)}}};
l.Ma=function(a,b){if(!this.g){var c=Pg(this,b);c&&ad(this.A,a,c)}};
function Pg(a,b){var c=b;if("string"==typeof b){if(a.S[b])return a.S[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.S[b]=c}return c?c:null}
function Xg(a,b){var c="ytPlayer"+b+a.I,d=x(function(a){var c=this.b&&this.b.args&&this.b.args.fflags;if(c&&0>c.indexOf("use_html5_player_event_timeout=true"))this.A.G(b,a);else{var d=U(x(function(){if(!this.g){this.A.G(b,a);var c=this.N,e=String(d);e in c&&delete c[e]}},this),0);
$a(this.N,String(d))}},a);
...
l.ya=function(){return this.M||(Tg(this)?"html5":null)};
l.xa=function(){return this.Y};
function Ug(a){Ag("dcp");a.cancel();Og(a);a.M=null;a.b&&(a.b.loaded=!1);var b=Tg(a);"html5"==(Tg(a)?"html5":null)&&(Sg(a)||!Vg(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.R;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.F&&ne(this.b.assets.js,this.F);Vd(this.ga);this.L=!1};
l.l=function(){Ug(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){S(b)}this.S=null;for(var a in this.i)p[this.i[a]]=null;this.Z=this.b=this.f=null;delete this.R;delete this.m;I.prototype.l.call(this)};
function Vg(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Yg={},Zg="player_uid_"+(1E9*Math.random()>>>0);function $g(a){var b="player";b=r(b)?Hb(b):b;a=Rf(a);var c=Zg+"_"+(b[ua]||(b[ua]=++va)),d=Yg[c];if(d)return d.da(a),d.f;d=new Ng(b,c);Yg[c]=d;ce("player-added",d.f);mc(d,y(ah,d));U(function(){d.da(a)},0);
return d.f}
function ah(a){delete Yg[a.I]}
...
function dh(a,b,c){if(ta(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function eh(a,b,c,d){if(ta(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function fh(a){var b=a.video_id||a.videoId;if(r(b)){var c=mf()||{},d=mf()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=of;if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function gh(a){I.call(this);this.b=a;this.b.subscribe("command",this.na,this);this.f={};this.i=!1}
A(gh,I);l=gh.prototype;l.start=function(){this.i||this.g||(this.i=!0,hh(this.b,"RECEIVING"))};
...
l.Oa=function(a,b){this.i&&!this.g&&hh(this.b,a,this.ba(a,b))};
l.ba=function(a,b){if(null!=b)return{value:b}};
function ih(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
l.l=function(){var a=this.b;a.g||ad(a.b,"command",this.na,this);this.b=null;for(var b in this.f)ih(this,b);gh.o.l.call(this)};function lh(a,b){gh.call(this,b);this.h=a;this.start()}
...
lh.prototype.ba=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return lh.o.ba.call(this,a,b)};
lh.prototype.l=function(){lh.o.l.call(this);delete this.h};function mh(a,b,c,d){I.call(this);this.f=b||null;this.u="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.F=!!a;this.m=x(this.A,this);window.addEventListener("message",this.m)}
n(mh,I);mh.prototype.A=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.F&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.u=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=La(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
mh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=xc(a);c.postMessage(d,this.u)}catch(e){S(e,"WARNING")}}};
mh.prototype.l=function(){window.removeEventListener("message",this.m);I.prototype.l.call(this)};function nh(a,b,c){mh.call(this,a,b,c||R("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(nh,mh);function oh(){var a=this.g=new nh(!!R("WIDGET_ID_ENFORCE")),b=x(this.Ia,this);a.i=b;a.j=null;this.g.channel="widget";if(a=R("WIDGET_ID"))this.g.sessionId=a;this.h=[];this.j=!1;this.i={}}
...
A(rh,oh);l=rh.prototype;l.pa=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&bh(a)){var d=b;if(ta(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=dh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ch.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=eh.apply(window,d)}d=e}fh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);bh(a)&&qh(this,this.ca())}};
...
l.dispose=function(){rh.o.dispose.call(this);for(var a=0;a<this.f.length;a++){var b=this.f[a];this.b.removeEventListener(b.eventType,b.listener)}this.f=[]};function sh(){I.call(this);this.b=new K;mc(this,y(nc,this.b))}
A(sh,I);sh.prototype.subscribe=function(a,b,c){return this.g?0:this.b.subscribe(a,b,c)};
sh.prototype.D=function(a){return this.g?!1:this.b.D(a)};
sh.prototype.j=function(a,b){this.g||this.b.G.apply(this.b,arguments)};function th(a,b,c){sh.call(this);this.f=a;this.h=b;this.i=c}
A(th,sh);function hh(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(xc(a),d.h))}}
th.prototype.l=function(){this.h=this.f=null;th.o.l.call(this)};function uh(a,b,c){I.call(this);this.b=a;this.h=c;this.i=df(window,"message",x(this.j,this));this.f=new th(this,a,b);mc(this,y(nc,this.f))}
A(uh,I);uh.prototype.j=function(a){var b;if(b=!this.g)if(b=a.origin==this.h)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,r(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.f,c.g||c.j("command",b.command,b.data,a.origin))}};
uh.prototype.l=function(){ef(this.i);this.b=null;uh.o.l.call(this)};function vh(){var a=wh()?"//googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//googleads.g.doubleclick.net/pagead/id",b=ab(xh);return new J(function(c,d){b.C=function(a){ve(a)?c(a):d(new yh("Request failed, status="+a.status,"net.badstatus",a))};
...
n(Dh,B);Dh.prototype.name="BiscottiMissingError";var xh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Eh=null;function Fh(){if("1"===Wa(Pd(),"args","privembed"))return Jc(Error("Biscotti ID is not available in private embed mode"));Eh||(Eh=Rc(vh().then(Gh),function(a){return Hh(2,a)}));
return Eh}
function wh(){var a;(a=!!Wa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie"))||(a=!!R("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1));return a||!!T("html5_serverside_pagead_id_sets_cookie")}
...
n(Lh,B);Lh.prototype.name="MutsuError";function Mh(){var a=new Lh("ID is missing"),b=new Lh("Timeout"),c=null,d=!1;Kd(function(){c=Id();d=!0});
if(d)return c?Ah(c):Bh(a);var e=new J(function(b,c){Kd(function(){var d=Id();d?b(d):c(a)})}),f=od().then(function(){return Jc(b)});
return Pc(Mc([e,f]),function(){return f.cancel()})}
;function Nh(a){if("1"!==Wa(Pd(),"args","privembed")){a&&!v("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Fh,void 0);try{var b=Kh();if(T("enable_mutsu")){v("yt.ads.mutsu.getId_")||t("yt.ads.mutsu.getId_",Mh,void 0);try{var c=v("yt.ads.mutsu.getId_")()}catch(d){c=Jc(d)}}else c=Jc(new Lh("unimplemented"));Nc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.aa||a.aa){b=b.value;a=a.value;var c={};c.dt=Rb;c.flash=yd||"0";a:{try{var d=window.top.location.href}catch(jb){d=2;break a}d=null!=d?d==window.document.location.href?
...
H.navigator.mimeTypes.length);d.ca_type=xd?"flash":"image";if(T("enable_server_side_search_pyv")||T("enable_server_side_mweb_search_pyv")){k=window;try{var m=k.screenX;var u=k.screenY}catch(jb){}try{var P=k.outerWidth;var qg=k.outerHeight}catch(jb){}try{var rg=k.innerWidth;var sg=k.innerHeight}catch(jb){}m=[k.screenLeft,k.screenTop,m,u,k.screen?k.screen.availWidth:void 0,k.screen?k.screen.availTop:void 0,P,qg,rg,sg];u=window.top;try{if(u.document&&!u.document.body)var X=new Gb(-1,-1);else{var Ca=
(u||window).document,Ad="CSS1Compat"==Ca.compatMode?Ca.documentElement:Ca.body;X=(new Gb(Ad.clientWidth,Ad.clientHeight)).round()}var Da=X}catch(jb){Da=new Gb(-12245933,-12245933)}X={};Ca=0;p.SVGElement&&p.document.createElementNS&&(Ca|=1);X.bc=Ca;X.bih=Da.height;X.biw=Da.width;X.brdim=m.join();Da=(X.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Pb.webkitVisibilityState||Pb.mozVisibilityState||Pb.visibilityState||""]||0,X.wgl=!!H.WebGLRenderingContext,X);for(var Bd in Da)d[Bd]=Da[Bd]}void 0!==
b&&(d.bid=b);void 0!==a&&(d.mutsuid=a);d.bsq=Oh++;Je("//www.youtube.com/ad_data_204",{za:!1,w:d})}});
U(Nh,18E5)}catch(d){S(d)}}}
var Oh=0;var Y=v("ytglobal.prefsUserPrefsPrefs_")||{};t("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Z(){this.b=R("ALT_PREF_COOKIE_NAME","PREF");var a;if(a=Xb.get(""+this.b,void 0)){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
Z.prototype.get=function(a,b){Ph(a);Qh(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
Z.prototype.set=function(a,b){Ph(a);Qh(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
Z.prototype.remove=function(a){Ph(a);Qh(a);delete Y[a]};
...
function Rh(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Z.b=void 0;Z.getInstance=function(){return Z.b?Z.b:Z.b=new Z};var Sh=null,Th=null,Uh=null,Vh={};function Wh(a){If(a.payload_name,a.payload,void 0,void 0)}
function Xh(a){var b=a.id;a=a.ve_type;var c=lf++;a=new jf(void 0,a,c,void 0,void 0);Vh[b]=a;b=sf();c=rf();b&&c&&Lf(b,c,a)}
function Yh(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Q("client-screen-nonce",b),Q("ROOT_VE_TYPE",a),a=rf()))for(var c in Vh){var d=Vh[c];d&&Lf(b,a,d)}}
function Zh(a){Vh[a.id]=new jf(a.tracking_params)}
function $h(a){var b=sf();a=Vh[a.id];b&&a&&(T("interaction_click_on_gel_web")?If("visualElementGestured",{csn:b,ve:kf(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):Mf({click:{csn:b,visualElement:kf(a)}}))}
function ai(a){a=a.ids;var b=sf();if(b)for(var c=0;c<a.length;c++){var d=Vh[a[c]];d&&If("visualElementShown",{csn:b,ve:kf(d),eventType:1})}}
...
t("writeEmbed",function(){var a=R("PLAYER_CONFIG",void 0);Nh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=R("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);R("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&fh(a.args);Sh=a=$g(a);a.addEventListener("onScreenChanged",Yh);a.addEventListener("onLogClientVeCreated",Xh);a.addEventListener("onLogServerVeCreated",Zh);a.addEventListener("onLogToGel",Wh);
a.addEventListener("onLogVeClicked",$h);a.addEventListener("onLogVesShown",ai);a.addEventListener("onReady",bi);b=R("POST_MESSAGE_ID","player");R("ENABLE_JS_API")?Uh=new rh(a):R("ENABLE_POST_API")&&r(b)&&r(c)&&(Th=new uh(window.parent,b,c),Uh=new lh(a,Th.f));R("BG_P")&&(R("BG_I")||R("BG_IU"))&&pe();Xe()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Me(a+"mac_204?action_fcts=1");return!0},void 0);
var ci=Qd(function(){Ag("ol");var a=Z.getInstance(),b=!!((Rh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&qc(document.body,"exp-invert-logo"))if(c&&!qc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):qc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&qc(document.body,"inverted-hdpi")&&rc();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Rh(b)||0;d=c?d|67108864:d&-67108865;
0==d?delete Y[b]:Y[b]=d.toString(16).toString();a=a.b;c=[];for(var e in Y)c.push(e+"="+encodeURIComponent(String(Y[e])));tf(a,c.join("&"),63072E3)}}),di=Qd(function(){var a=Sh;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();R("PL_ATT")&&(oe=null);a=0;for(var b=Ve.length;a<b;a++)Ue(Ve[a]);Ve.length=0;me("//static.doubleclick.net/instream/ad_status.js");We=!1;Q("DCLKSTAT",0);oc(Uh,Th);if(a=Sh)a.removeEventListener("onScreenChanged",Yh),a.removeEventListener("onLogClientVeCreated",Xh),a.removeEventListener("onLogServerVeCreated",Zh),a.removeEventListener("onLogToGel",Wh),a.removeEventListener("onLogVeClicked",$h),a.removeEventListener("onLogVesShown",ai),a.removeEventListener("onReady",
bi),a.destroy();Vh={}});
